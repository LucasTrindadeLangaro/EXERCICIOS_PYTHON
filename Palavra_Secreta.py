...
palavras = {'Italia'.upper():'É um pais com formato de bota', 'GitHub'.upper():'site onde é possivel criar repositórios',
            'Python'.upper():'Linguagem de programação criada por Guido Van Rossum',
            'Windows'.upper():'sistema da microsoft'}
